...
export function OfferRideForm({ userId, savedLocations = [] }: { userId?: string, savedLocations?: any[] }) {
                ...
                <div className="flex gap-2 mt-2 overflow-x-auto pb-1 hide-scrollbar">
                  {savedLocations.map((loc) => (
                    <Button 
                      ...
                      onClick={() => { setPickup({ lat: loc.lat, lng: loc.lng, address: loc.address }); setRouteInfo(null); }}
                    >
                ...
                <div className="flex gap-2 mt-2 overflow-x-auto pb-1 hide-scrollbar">
                  {savedLocations.map((loc) => (
                    <Button 
                      ...
                      size="sm" 
                      className="h-6 text-[10px] px-2 rounded-full whitespace-nowrap bg-slate-50 border-slate-200 hover:bg-slate-100" 
                      onClick={() => { setDropoff({ lat: loc.lat, lng: loc.lng, address: loc.address }); setRouteInfo(null); }}
                    >
