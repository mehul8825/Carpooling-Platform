...
export default async function Page() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      {/* Hero Section */}
      <section className="relative overflow-hidden py-20 px-4 text-center bg-gradient-to-b from-blue-50/80 via-white to-slate-50/50">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-900 bg-clip-text">
            Share Rides, Save Money, <br />
            <span className="text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
              Save the Planet
            </span>
          </h1>
